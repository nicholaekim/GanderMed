...
import type { Alert, DoseEvent, ExposureReport, Medication, Severity } from "@/lib/types";
      ...
      {!loaded ? (
        ...
        <>
          ...
          <p className="mt-8 text-[10px] leading-relaxed text-slate-400">
            ...
            live); conflict screening from a demonstration ruleset (v{RULESET_VERSION}) compiled from
            public product-monograph warnings — not a licensed clinical interaction database.
